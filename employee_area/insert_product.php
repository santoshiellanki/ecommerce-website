...
<html>
  ...
  <body bgcolor="white">
      <form action="insert_product.php" method="post" enctype="multipart/form-data">
		  ...
		  <table align="left" width="740" border="2" bgcolor="white">
			  ...
			  <tr>
				  ...
				  <td>
					  <select name="product_cat">
					  	...
					  	while ($Cat_Inf_Res=mysqli_fetch_array($Cat_Inf_Run)){
					  		$cat_id = $Cat_Inf_Res{'cat_id'};
					  		$cat_title = $Cat_Inf_Res{'cat_title'};
...
<?php
    ...
    move_uploaded_file($product_image_tmp,"../admin_area/product_images/$Prod_Ins_Img");
